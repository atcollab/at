...
void BndMPoleSymplectic4Pass(double *r, double le, double irho, const double *A, const double *B,
	int max_order, int num_int_steps,
	double entrance_angle, 	double exit_angle,
	double fint1, double fint2, double gap,
	double *T1, double *T2,	
	double *R1, double *R2, int num_particles);
void BndMPoleSymplectic4RadPass(double *r, double le, double irho, const double *A, const double *B,
	int max_order, int num_int_steps,
	double entrance_angle, 	double exit_angle,
	double fint1, double fint2, double gap,
	double *T1, double *T2,	
...
void BndMPoleSymplectic4E2RadPass(double *r, double le, double irho, const double *A, const double *B,
	...
	double E0,
	int num_particles);
void StrMPoleSymplectic4Pass(double *r, double le, const double *A, const double *B,
	int max_order, int num_int_steps,
	double *T1, double *T2,	
	double *R1, double *R2, int num_particles);
