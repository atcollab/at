...
void DriftPass(double *r_in, double le,
    const double *T1, const double *T2, const double *R1, const double *R2,
    const double *RApertures, const double *EApertures,
    int num_particles);
void QuadLinearPass(double *r, double le, double kv,
    const double *T1, const double *T2, const double *R1, const double *R2,
    int num_particles);
...
void ThinMPolePass(double *r,
    const double *A, const double *B, int max_order,
    double bax, double bay,
    const double *T1, const double *T2, const double *R1, const double *R2,
    int num_particles);
void CorrectorPass(double *r_in, double xkick, double ykick, double le, int num_particles);
void BndMPoleSymplectic4Pass(double *r, double le, double irho,
    const double *A, const double *B, int max_order, int num_int_steps,
    double entrance_angle, 	double exit_angle,
    double fint1, double fint2, double gap,
    const double *T1, const double *T2, const double *R1, const double *R2,
    const double *RApertures, const double *EApertures,
    int num_particles);
void BndMPoleSymplectic4RadPass(double *r, double le, double irho,
    const double *A, const double *B, int max_order, int num_int_steps,
    double entrance_angle, double exit_angle,
    double fint1, double fint2, double gap,
    const double *T1, const double *T2, const double *R1, const double *R2,
...
void BndMPoleSymplectic4FrgFPass(double *r, double le, double irho,
    const double *A, const double *B, int max_order, int num_int_steps,
    double entrance_angle, double exit_angle,
    double fint1, double fint2, double gap,
    const double *T1, const double *T2, const double *R1, const double *R2,
    const double *RApertures, const double *EApertures,
    int num_particles);
void BndMPoleSymplectic4FrgFRadPass(double *r, double le, double irho,
    const double *A, const double *B, int max_order, int num_int_steps,
    double entrance_angle, double exit_angle,
    double fint1, double fint2, double gap,
    const double *T1, const double *T2, const double *R1, const double *R2,
    const double *RApertures, const double *EApertures,
    double E0, int num_particles);
void BndMPoleSymplectic4E2Pass(double *r, double le, double irho,
    const double *A, const double *B, int max_order, int num_int_steps,
	double entrance_angle, 	double exit_angle,
	double fint1, double fint2, double gap,
	double h1, double h2,
    const double *T1, const double *T2, const double *R1, const double *R2,
    int num_particles);
void BndMPoleSymplectic4E2RadPass(double *r, double le, double irho,
    const double *A, const double *B, int max_order, int num_int_steps,
	double entrance_angle, 	double exit_angle,
	double fint1, double fint2, double gap,
	double h1, double h2,
    const double *T1, const double *T2, const double *R1, const double *R2,
	double E0, int num_particles);
void StrMPoleSymplectic4Pass(double *r, double le,
    const double *A, const double *B, int max_order, int num_int_steps,
    const double *T1, const double *T2, const double *R1, const double *R2,
    double *RApertures, double *EApertures,
    int num_particles);
void QuadMPoleFringePass(double *r, double le,
    const double *A, const double *B, int max_order, int num_int_steps,
    const double *T1, const double *T2, const double *R1, const double *R2,
    const double *fringeIntM0,  /* I0m/K1, I1m/K1, I2m/K1, I3m/K1, Lambda2m/K1 */
    const double *fringeIntP0,  /* I0p/K1, I1p/K1, I2p/K1, I3p/K1, Lambda2p/K1 */
    const double *RApertures, const double *EApertures,
    int num_particles);
