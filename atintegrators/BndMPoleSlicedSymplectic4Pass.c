...
void BndMPoleSymplectic4Pass(double *r, double *le_array, double *irho_array, double *A_array, double *B_array,
        int max_order, int num_int_steps,
        double *entrance_angle_array, 	double *exit_angle_array,
        double fint1, double fint2, double gap,
        double *T1, double *T2,
        double *R1, double *R2, int num_particles, int Nslices)
...
{	double *A , *B, *le, *ba, *irho, *entrance_angle, *exit_angle;
     ...
     */
        ...
        {	A = mxGetPr(mxGetFieldByNumber(ElemData, 0, FieldNumbers[0]));
            ...
            ba = mxGetPr(mxGetFieldByNumber(ElemData, 0, FieldNumbers[5]));
            entrance_angle = mxGetPr(mxGetFieldByNumber(ElemData, 0, FieldNumbers[6]));
            exit_angle = mxGetPr(mxGetFieldByNumber(ElemData, 0, FieldNumbers[7]));
    ...
    BndMPoleSymplectic4Pass(r_in, le, irho, A, B, max_order, num_int_steps,
            entrance_angle, exit_angle, fint1, fint2, gap, pt1, pt2, pr1, pr2, num_particles, Nslices);
...
{	int m, n, ii;
    ...
    if(nrhs) {
        ...
        r_in = mxGetPr(plhs[0]);
        BndMPoleSymplectic4Pass(r_in, le, irho, A, B, max_order, num_int_steps,
                entrance_angle, exit_angle, fint1, fint2, gap, pt1, pt2, pr1, pr2, n, Nslices);
