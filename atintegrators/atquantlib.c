...
double bs_invfunc(double y,double lo,double hi,double delta){
...
double interpolate(int ip,double p){   
    double intp;
...
static double getEnergy(double ec){
...
int poissonRandomNumber(double lamb){
