...
void StrOldRadPass(double *r, double le, double *A, double *B,
        ...
        double *r_in, int num_particles, struct parameters *Param)
{
    ...
    StrOldRadPass(r_in, Elem->Length, Elem->PolynomA, Elem->PolynomB,
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    if (nrhs == 2) {
        ...
        StrOldRadPass(r_in, Length, PolynomA, PolynomB,
