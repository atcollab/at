...
void RFBeamLoadingCavityPass(double *r_in, double le, double nv,
        ...
        double *r_in, int num_particles, struct parameters *Param)
{
    ...
    RFBeamLoadingCavityPass(r_in, Elem->Length, Elem->Voltage/Elem->Energy,
...
MODULE_DEF(RFBeamLoadingCavityPass)        /* Dummy module initialisation */
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    if(nrhs == 2)
    {
        ...
        RFBeamLoadingCavityPass(r_in, Length, Voltage/Energy, Frequency,
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    mexErrMsgIdAndTxt("AT:MissingMexFile", "Not implemented on Windows");
}
#endif /*MATLAB_MEX_FILE*/
