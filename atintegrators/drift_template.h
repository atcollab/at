...
void drift_pass(double *r_in, double le,
...
*/
{
    #pragma omp parallel for if (num_particles > OMP_PARTICLE_THRESHOLD * 10) default(none) \
    shared(r_in, le, num_particles, RApertures, EApertures, T1, T2, R1, R2)
...
MODULE_DEF(DRIFT_PASS)        /* Dummy module initialisation */
