/* 
 *  FieldMapPass.c
 *  PassMethod for Accelerator Toolbox to track throug a magnet described with a Field Map
 *
 *  10/07/2018
 *  Nicola Carmignani
 */
...
#include "atelem.c"
#include "atlalib.c"
#include "driftkickFM.c"		/* it includes the struct elem definition, fastdrift.c, interpolation functions*/
#include<math.h>
