...
void GWigInit(struct gwigR *pWig, double Eg, double Ltot, double Lw, double Bmax,
...
/*NEW PART 2 --------------------------------------------------------------------------------*/
void GWigInit(struct gwigR *Wig,double Eg, double Ltot, double Lw, double Bmax,
	      int Nstep, int Nmeth, int NHharm, int NVharm,
		  int HSplitPole,int VSplitPole,double *zEndPointH,double *zEndPointV,
	      double *pBy, double *pBx, double *T1, double *T2, 
	      double *R1, double *R2)
...
/*
  ...
  */
  /*double pCentral , particleCharge , particleMass , c_mks;*/
  Wig->E0 = Eg*1e-9;
  Wig->Po = Wig->E0/XMC2;
  Wig->Pmethod = Nmeth;
  Wig->PN = Nstep;
