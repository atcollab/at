...
def test_ohmi_envelope(request, lattice, refpts):
    ...
    assert_close(obs['r66'], numpy.array([
        [ 9.136531199268e-10, -3.482509370896e-15, -1.478776565972e-25,  1.117896376156e-25,  1.507761207336e-09, -1.201361441742e-15],
        [-3.482506326979e-15,  1.913558683843e-11, -5.329586638176e-29, -3.635706991286e-29, -2.511082949346e-13, -1.287049295378e-13],
        [-8.295376891641e-26,  1.377884772282e-29, -5.958839242880e-38, -3.685820482104e-38, -4.803818616604e-23,  6.115074508445e-24],
        [-3.277341960926e-25,  5.490677891284e-29,  7.372856219488e-38, -2.033474435939e-38, -1.897834780211e-22,  2.416770788304e-23],
        [ 1.507761207336e-09, -2.511082949323e-13, -8.479590331354e-23,  6.488719710490e-23,  8.731203896188e-07,  9.794518066586e-10],
        [-1.201014103992e-15, -1.287049295969e-13,  8.085868846133e-21,  1.427286088587e-21,  9.794520077951e-10,  9.357805914412e-06]]),
        rtol=1.0E-12, atol=1.0E-15)

    assert_close(obs['r44'], numpy.array([
        [ 9.110494192772e-10, -3.048902425919e-15,  0.000000000000e+00,  0.000000000000e+00],
        [-3.048899381999e-15,  1.913558676445e-11,  0.000000000000e+00,  0.000000000000e+00],
        [ 0.000000000000e+00,  0.000000000000e+00,  0.000000000000e+00,  0.000000000000e+00],
        [ 0.000000000000e+00,  0.000000000000e+00,  0.000000000000e+00,  0.000000000000e+00]]),
        rtol=1E-12, atol=1.0E-15)

    assert_close(obs['m66'], numpy.array([
