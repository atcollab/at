...
def get_fmap(ring: Lattice, **kwargs: dict[str, any]) -> dict[str, any]:
    ...
    return {
        ...
        "nu_axes_names": np.array(_coord_index[nuaxes, 0]),
        "nturns": np.array(nturns),
        "nu_" + _coord_index[nuaxes[0], 0]: np.array(x1freq),
        "nu_" + _coord_index[nuaxes[1], 0]: np.array(x2freq),
        "dnu_" + _coord_index[nuaxes[0], 0]: np.array(x1diff),
        "dnu_" + _coord_index[nuaxes[1], 0]: np.array(x2diff),
