...
class MultipoleElement(BasicElement):
    ...
    def _set_xs_poly(self):
        ...
        if korder == 1:
            self.xsuite_params["edge_entry_active"] = self.atparams.get(
