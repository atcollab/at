...
class ResponseMatrix(SvdResponse):
    ...
    It is defined by any arbitrary set of :py:class:`~.variables.Variable`\ s and
    :py:class:`.Observable`\s

    Addition is defined on :py:class:`ResponseMatrix` objects as the addition
    of their :py:class:`~.variables.Variable`\ s and :py:class:`.Observable`\s to
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            variables:      List of :py:class:`~.variables.Variable`\ s
