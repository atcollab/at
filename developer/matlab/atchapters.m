...
%CHAPTERS=ATCHAPTERS()
%
% ATCHAPTERS must be edited to add or modify the chapters of the User's
% guide
%
%ATCHAPTERS is a structure array where each element defines one chapter
%ATCHAPTERS has 3 fields;
...
k.contents=["isatlattice",...
    ...
    "0The global lattice properties 'FamName', 'Energy', 'Periodicity', 'Particle', 'HarmNumber' " + ...
    "are stored in the RingParam lattice element.", ...
    "0The following functions gives an easy access to them:", ...
    "atGetRingProperties", "atSetRingProperties", "atenergy", ...
    ...
    "-Join elements", "atreduce", "combinebypassmethod", "combinelinear45",...
    "-Other",...
    "atloadfielderrs",...
    "atsetRFCavity", "atsetshift", "atsettilt",...
    "settags", "findtags", "mvelem", "mvfield"];

a.id = "atloadsave";
a.title = "Loading and Saving lattices";
a.contents = ["-Loading lattices from files", "atloadlattice"...
    "-Binary files", ...
