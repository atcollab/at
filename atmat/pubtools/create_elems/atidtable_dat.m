...
%
% Returns
%   An InsertionDeviceKickMap with the loaded table registered as the
%   active 'default' entry in KickmapStore.
%
...
Elem = atinsertiondevicekickmap( ...
    ...
    'xtable',x, ...
    'ytable',y, ...
    'KickmapStore',struct('default',kickmapData), ...
    'ActiveKickmap','default' ...
);
end
