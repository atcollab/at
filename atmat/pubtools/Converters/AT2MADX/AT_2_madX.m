    ...
    switch type
        case {'DI','Dipole','Bend'} % dipole
            ...
            di=[el.('FamName')   ': '...
                ...
                ' K0 = ' num2str(el.('PolynomB')(1),format) ', '...
            ...
            di=[di ' FINT= ' num2str(el.('FringeInt1'),format) ', '...
                ' FINTX= ' num2str(el.('FringeInt2'),format) ', '...
                ' hgap= ' num2str(el.('FullGap'),format) '/2, '...
                ];
            end
        ...
        case {'MP','Multipole'} % multipole
            ...
            mp=[el.('FamName')   ': '...
                ' Drift,  L= ' num2str(el.('Length'),format)  '; '...
                ];
        ...
        case {'KI','Corrector'} % kicker
            ki=[el.('FamName') ' :KICKER, L= ' num2str(el.('Length'),format)  ' '...
