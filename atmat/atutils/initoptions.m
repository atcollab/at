...
%  XYStep = 1.0E-8;    Transverse step (for findorbitx, findmxx,...)
%  DPStep = 1.0E-6;    Momentum step (for dispersion and chromaticity)
...
opts.XYStep = 1.0E-8;   % Transverse step (for findorbitx, findmxx,...)
opts.DPStep = 1.0E-6;   % Momentum step (for dispersion and chromaticity)
