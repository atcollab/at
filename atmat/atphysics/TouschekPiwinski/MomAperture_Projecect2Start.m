...
% MOMAPERTURE_PROJECECT2START calculates the local momentum aperture
%
% MOMAPERTURE_PROJECECT2START is a Bipartition search of the negative and 
...
%
% [ETN, ETP]=MOMAPERTURE_PROJECECT2START()
% [ETN, ETP]=MOMAPERTURE_PROJECECT2START(THERING)
% [ETN, ETP]=MOMAPERTURE_PROJECECT2START(THERING,REFPTS)
% [ETN, ETP]=MOMAPERTURE_PROJECECT2START(THERING,REFPTS,nturns)
% [ETN, ETP]=MOMAPERTURE_PROJECECT2START(THERING,REFPTS,nturns,detole)
% [ETN, ETP]=MOMAPERTURE_PROJECECT2START(THERING,REFPTS,nturns,detole,eu_ini)
% [ETN, ETP]=MOMAPERTURE_PROJECECT2START(THERING,REFPTS,nturns,detole,eu_ini,initcoord)
% [ETN, ETP]=MOMAPERTURE_PROJECECT2START(THERING,REFPTS,nturns,detole,eu_ini,initcoord,verbose)
%          
%
% Output:
