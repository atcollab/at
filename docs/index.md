...
- a [python interface][2], available as a python package, [doxygen documentation page][3] and [doxygen latex pdf][4]
...
[4]: https://github.com/atcollab/at/blob/doxy-docs/docs/p/doxy/latex/refman.pdf "python doxygen documentation pdf"
